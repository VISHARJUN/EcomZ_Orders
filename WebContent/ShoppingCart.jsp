...
<body>
	...
	<p>
		<font face="Verdana, Arial, Helvetica, sans-serif"><strong>Shopping Cart</strong></font>
	</p>
	<p>
		<a href="ProductList.jsp" >Model List</a>
	</p>
	<table width="75%" border="1">
		<tr bgcolor="#CCCCCC">
			<td><strong><font size="2"
					face="Verdana, Arial, Helvetica, sans-serif">Product Description</font></strong></td>
			<td><strong><font size="2"
		...
		<jsp:useBean id="cart" scope="session"
			class="com.ecomz.orders.model.Cart_Crud_Bean" />
		<c:if test="${cart.getItemsCount()==0}">
			<tr>
				<td colspan="4"><font size="2"
					face="Verdana, Arial, Helvetica, sans-serif">- Cart is currently empty -<br />
			</tr>
		</c:if>
				...
				<tr>
					<td><font size="2"
						face="Verdana, Arial, Helvetica, sans-serif"><b><c:out
									value="${cartItem.productId}" /></b><br /> <c:out
								value="${cartItem.productDescription}" /></font></td>
					<td><font size="2"
